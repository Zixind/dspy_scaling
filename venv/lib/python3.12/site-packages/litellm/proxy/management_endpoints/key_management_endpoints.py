...
async def delete_key_fn(
    ...
    Parameters::
    - keys (List[str]): A list of keys or hashed keys to delete. Example {"keys": ["OPENAI_KEY_REDACTED", "837e17519f44683334df5291321d97b8bf1098cd490e49e215f6fea935aa28be"]}
    - key_aliases (List[str]): A list of key aliases to delete. Can be passed instead of `keys`.Example {"key_aliases": ["alias1", "alias2"]}

    Returns:
    - deleted_keys (List[str]): A list of deleted keys. Example {"deleted_keys": ["OPENAI_KEY_REDACTED", "837e17519f44683334df5291321d97b8bf1098cd490e49e215f6fea935aa28be"]}
...
async def info_key_fn(
    ...
    Example Curl:
    ```
    curl -X GET "http://0.0.0.0:4000/key/info?key=OPENAI_KEY_REDACTED" \
-H "Authorization: Bearer sk-1234"
    ```
    ...
    ```
    curl -X GET "http://0.0.0.0:4000/key/info" \
-H "Authorization: Bearer OPENAI_KEY_REDACTED"
    ```
    """
    from litellm.proxy.proxy_server import prisma_client
